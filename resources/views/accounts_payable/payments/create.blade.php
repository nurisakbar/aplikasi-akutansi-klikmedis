...
<div class="container-fluid">
    ...
    <form method="POST" action="{{ route('accounts-payable.payments.store', $payable) }}" class="row g-3">
        @csrf
        <div class="col-md-3">
            <label>Tanggal</label>
        ...
        <div class="col-md-12">
            ...
            <a href="{{ route('accounts-payable.show', $payable) }}" class="btn btn-secondary">Batal</a>
        </div>
    </form>
</div>
@endsection
