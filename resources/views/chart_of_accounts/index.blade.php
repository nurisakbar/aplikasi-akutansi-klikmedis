...
@push('custom_js')
    <script>
        $(document).ready(function() {
            ...
            // Function untuk delete dengan form submission
            function deleteAccountForm(accountId) {
                var form = $('#delete-form');
                form.attr('action', '{{ route('chart-of-accounts.destroy', ':id') }}'.replace(':id', accountId));
                form.submit();
            }

            // Global function untuk dipanggil dari HTML onclick
            window.deleteRecord = function(accountId) {
                if (!accountId) {
                    Swal.fire('Error!', 'ID akun tidak valid.', 'error');
                    return;
                }
            ...
            // Alternative function untuk form submission
            window.deleteRecordForm = function(accountId) {
                if (!accountId) {
                    Swal.fire('Error!', 'ID akun tidak valid.', 'error');
                    return;
                }
